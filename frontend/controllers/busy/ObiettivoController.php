...
public function actionUpload()
     ...
     * @return string
     */
    public function actionPrintrelazione($nomepdc, $nomerelaz, $IdObiettivo)
    {
        $searchModel = new ObiettivoSearch();
        ...
        $content = $this->renderPartial('printdocobiettivo', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
            'IdObiettivo' => $IdObiettivo,
            'nomepdc' => $nomepdc,
     ...
     * @return string
     */
    public function actionPrint($nomepdc, $nomerelaz, $IdObiettivo)
    {
        $searchModel = new ObiettivoSearch();
        if ($nomerelaz == "Obiettivo_Lavoro" ) 
                $dataProvider = $searchModel->searchLavoro($this->request->queryParams, $IdObiettivo);
